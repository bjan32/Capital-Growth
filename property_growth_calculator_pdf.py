...
# User input: Purchase year
purchase_year = st.number_input("Enter the year the property was bought:", min_value=1900, max_value=2100, value=2016, step=1)
...
if uploaded_pdf is not None:
    # Extract growth rates from PDF
    growth_rates = extract_growth_rates_from_pdf(uploaded_pdf)
